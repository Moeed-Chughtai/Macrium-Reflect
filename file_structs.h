...
namespace file_structs
{
	...
	NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE_WITH_DEFAULT(DiskSpaceManagement, low_space_purge, low_space_gb_threshold, incrementals_forever, apply_to_all_sets_in_folder, run_before, full_retention, incremental_retention, differential_retention);
